...
from components.nutrigrade import get_nutrigrade_html
from components.sugarcube import display_sugarcube_visual
from components.fat_visual import display_fat_visual
